...
const CreateFoodDash = () => {
    ...
    const handleSubmit = ( event ) => {
        ...
        if ( !isError ) {
            ...
            fetch('http://localhost:3030/foods/create', {
                method: "POST",
                body: formData,
            })
                .then(response => {
    ...
    return (
        ...
        <>
            ...
            <div className='p-5'>
                ...
                <h1 className='d-block w-100 mb-5 pb-3 border-bottom border-3 border-warning'>Creando una nueva comida</h1>
                ...
                <Form encType='multipart/form-data' onSubmit={ handleSubmit }>
                    ...
                    <Form.Group className="col-md-8 mx-auto mb-3">
                        ...
                        <Form.Control type="text" id="title" name='title' placeholder="Ej: Del Campo" className='bg-transparent border-warning text-light' onChange={ handleInput } onBlur={ handleInput } />
                        {
                            errorsState.title &&
                    ...
                    <Form.Group className="col-md-8 mx-auto mb-3">
                        ...
                        <Form.Control type="text" id="description" name='description' placeholder="Ej: 100grs de carne, lechuga..." className='bg-transparent border-warning text-light' onChange={ handleInput } onBlur={ handleInput } />
                        {
                    ...
                    <Button type='submit' variant='warning' className='fw-bold py-2 mt-4'>Crear comida</Button>
...
export default authenticatedRoute( CreateFoodDash );